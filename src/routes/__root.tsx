  ...
  head: () => ({
    meta: [
      ...
      { title: "ZeroMotion" },
      {
        name: "description",
        content:
          "Privacy-first, AI-powered knee recovery. Your health data never leaves your device.",
      },
      { name: "theme-color", content: "#FFF7BC" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { property: "og:title", content: "ZeroMotion" },
      {
        property: "og:description",
        content: "Recovery you can prove. Data nobody can read.",
      },
